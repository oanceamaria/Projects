...
void unitConverterClick(){
  ...
  if ( mouseX > 0 && mouseX < width && mouseY > height/10 + 3*height/8.9 && mouseY < height/10 + 4*height/8.9 ) {
    pageUC = 4;
    page = -1;
  }
  ...
  if ( mouseX > 0 && mouseX < width && mouseY > height/10 + 5*height/8.9 && mouseY < height/10 + 6*height/8.9 ) {
    pageUC = 6;
    page = -1;
  }
